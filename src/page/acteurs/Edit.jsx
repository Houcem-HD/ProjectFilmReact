...
const EditActeurForm = () => {
  ...
  console.log("Actor ID from URL:", id); // Log the actor ID
  ...
  useEffect(() => {
    const fetchActorData = async () => {
      try {
        ...
        console.log("Actor data:", response.data); // Log the response to check the data structure

        const { nom, prenom, nationalite, date_naissance } = response.data;

        // Check if date_naissance exists and format it if needed
        if (date_naissance) {
